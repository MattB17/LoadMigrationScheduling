...
def test_with_no_instances(mock_extract, mock_write):
    solve_instances_optimally(
        [], "/an/input/dir", "migrations", "/an/output/dir")
...
def test_with_1_instance(mock_extract, mock_write):
    solve_instances_optimally(["file1.txt"], "/inputs", "file", "/outputs")
    mock_extract.assert_called_once_with("file1.txt", "file")
    mock_write.assert_called_once_with("file1.txt", "/inputs", 5, "/outputs")
...
def test_with_multi_instances(mock_extract, mock_write):
    solve_instances_optimally(
        ...
        "/input/dir", "migrations", "/output/dir")
    ...
    write_calls = [call("migrations0.txt", "/input/dir", 0, "/output/dir"),
                   call("migrations1.csv", "/input/dir", 1, "/output/dir"),
                   call("migrations2.dat", "/input/dir", 2, "/output/dir")]
